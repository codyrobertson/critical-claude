...
// Utility functions
export function generateMetricId(command?: string, action?: string): string {
...
export function createMetric(data: CreateMetricData): UsageMetric {
  return {
...
export function calculateStats(metrics: UsageMetric[]): UsageStats {
