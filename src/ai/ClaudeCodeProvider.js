...
export class ClaudeCodeProvider {
    ...
    async execute(prompt) {
        try {
            ...
            this.logger.error('Claude Code SDK execution error', error);
            return {
                content: '',
                success: false,
     ...
     */
    async getFullConversation(prompt) {
        try {
            const abortController = new AbortController();
            ...
            this.logger.error('Failed to get full conversation', error);
            return [];
        }
    }
}
