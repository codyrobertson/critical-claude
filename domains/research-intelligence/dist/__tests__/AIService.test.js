...
describe('AIService', () => {
    ...
    describe('conductResearchAnalysis', () => {
        it('should analyze search results', async () => {
            ...
            const result = await aiService.conductResearchAnalysis('Machine Learning', ['ML best practices', 'deep learning'], mockResults);
            expect(result).toBeDefined();
        ...
        it('should provide fallback analysis on parsing error', async () => {
            const result = await aiService.conductResearchAnalysis('Test Area', ['test query'], []);
            expect(result).toBeDefined();
    ...
    describe('generateStructured', () => {
        it('should generate structured response', async () => {
            ...
            const result = await aiService.generateStructured('Generate a test response', schema);
            expect(result).toBeDefined();
        ...
        it('should provide fallback for comprehensive report schema', async () => {
            ...
            const result = await aiService.generateStructured('Generate comprehensive report', reportSchema);
            expect(result).toBeDefined();
...
export async function runAIServiceTests() {
    ...
    try {
        ...
        const analysisResult = await aiService.conductResearchAnalysis('Test Area', ['test query'], [{ title: 'Test', snippet: 'Test snippet', url: 'https://test.com' }]);
