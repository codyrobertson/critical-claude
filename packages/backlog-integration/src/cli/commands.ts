...
export class CriticalClaudeCommands {
   ...
   */
  private async handleAgileCommand(subcommand: string, input: any, options: any): Promise<void> {
  ...
  private async startSprint(id: string): Promise<void> {
    try {
      ...
      console.error(chalk.red(`Failed to start sprint: ${(error as Error).message}`));
    }
  }
  ...
  private async completeSprint(id: string, options: any): Promise<void> {
    try {
      ...
      console.error(chalk.red(`Failed to complete sprint: ${(error as Error).message}`));
    }
  }
  ...
  private async generateSprintReport(id: string, options: any): Promise<void> {
    try {
      ...
      console.error(chalk.red(`Failed to generate sprint report: ${(error as Error).message}`));
    }
  }
  ...
  private async aiSprintPlan(options: any): Promise<void> {
    ...
    try {
      ...
      console.error(chalk.red(`AI sprint planning failed: ${(error as Error).message}`));
    }
  }
  ...
  private async aiEstimateTasks(taskIds: string[], options: any): Promise<void> {
    ...
    try {
      ...
      console.error(chalk.red(`AI estimation failed: ${(error as Error).message}`));
    }
  }
  ...
  private async analyzeVelocity(options: any): Promise<void> {
    ...
    try {
      ...
      console.error(chalk.red(`Velocity analysis failed: ${(error as Error).message}`));
    }
  }
  ...
  private async analyzeRisks(options: any): Promise<void> {
    ...
    try {
      ...
      console.error(chalk.red(`Risk analysis failed: ${(error as Error).message}`));
    }
  }
  ...
  private async generateBurndown(sprintId: string, options: any): Promise<void> {
    ...
    try {
      ...
      console.error(chalk.red(`Burndown generation failed: ${(error as Error).message}`));
    }
  }
