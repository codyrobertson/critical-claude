...
import type { BacklogManager } from '../cli/backlog-manager.js';

/**
 * Create a mock BacklogManager for testing
 */
export function createMockBacklogManager(): any {
  return {
 ...
 */
export function createTestClaudeCodeTodo(overrides: any = {}) {
  return {
    id: `todo-${Date.now()}`,
 ...
 */
export function setupTestEnvironment(scenario: 'development' | 'production' | 'ci') {
