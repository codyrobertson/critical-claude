...
function initializeCLI() {
    ...
    taskCmd
        ...
        try {
            ...
            logger.error('Task focus failed', error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger.error('Quick task creation failed', error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger.error('Claude Code sync failed', error);
            process.exit(1);
        }
    });
    // Status overview
    program
        ...
        try {
            ...
            logger.error('Status overview failed', error);
            process.exit(1);
        }
    });
    // Help enhancements
