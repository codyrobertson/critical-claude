...
program
    ...
    try {
        ...
        console.error(chalk.red(`Task UI failed: ${error.message}`));
        process.exit(1);
    }
});
...
program
    ...
    try {
        ...
        console.error(chalk.red(`Live monitor failed: ${error.message}`));
        process.exit(1);
    }
});
...
program
    ...
    try {
        ...
        console.error(chalk.red(`Hooks command failed: ${error.message}`));
        process.exit(1);
    }
});
...
program
    ...
    try {
        ...
        console.error(chalk.red(`Claude Code hooks command failed: ${error.message}`));
        process.exit(1);
    }
});
...
program
    ...
    try {
        ...
        console.error(chalk.red(`Hook status check failed: ${error.message}`));
        process.exit(1);
    }
});
program
...
program
    ...
    try {
        ...
        console.error(chalk.red(`Hook upgrade failed: ${error.message}`));
        process.exit(1);
    }
});
program
    ...
    try {
        ...
        console.error(chalk.red(`Comprehensive hook test failed: ${error.message}`));
        process.exit(1);
    }
});
program
    ...
    try {
        ...
        console.error(chalk.red(`Real Claude integration test failed: ${error.message}`));
        process.exit(1);
    }
});
// Parse command line
