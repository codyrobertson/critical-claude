...
export class PerformanceAnalyzer {
    ...
    checkNestedLoops(code, filename, issues) {
        // Find nested loops
    ...
    checkSynchronousOperations(code, filename, issues) {
        const syncPatterns = [
    ...
    checkMemoryLeaks(code, filename, issues) {
    ...
    checkIneffientAlgorithms(code, filename, issues) {
    ...
    checkDatabaseQueries(code, filename, issues) {
        // N+1 query problem
    ...
    checkCaching(code, filename, issues) {
