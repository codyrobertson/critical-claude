    ...
    switch (request.params.name) {
        case 'cc_plan_timeline': {
            ...
            try {
                ...
                logger.error('Failed to generate timeline', { input }, error);
        ...
        case 'cc_plan_arch': {
            ...
            const issues = []; // Simplified for this service
...
Run 'cc_explore_codebase' to analyze your codebase structure.`,
        ...
        case 'cc_explore_codebase': {
            ...
            try {
                ...
                logger.error('Codebase exploration failed', { rootPath }, error);
                throw new Error(`Failed to explore codebase: ${error.message}`);
            }
        }
        default:
